...
export default function ServicesSection() {
    ...
    return (
        <section id="services" className="py-7 px-5 bg-white">
            <div className="container mx-auto px-8 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-9 text-left">
                    {columns.map((col, idx) => (
                        <div
                            key={idx}
                            className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 p-6 rounded-2xl shadow hover:shadow-lg transition"
                        >
