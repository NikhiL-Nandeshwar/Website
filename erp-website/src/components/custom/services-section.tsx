    ...
    const columns = [
        ...
        },
        {
            ...
            points: [
                ...
                "UI/UX tailored for Institutions & Businesses",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
                    {columns.map((col, idx) => (
                        ...
                        >
                            ...
                            <CardContent>
                                <ul className="space-y-2 text-[15px] text-gray-700 dark:text-gray-300 mt-2">
                                ...
                                <div className="mt-6 flex justify-start">
                                    ...
                                    >
                                        <FaWhatsapp className="text-green-500 dark:text-green-400" size={20} />
                                        <span className="text-green-500 dark:text-green-400">Contact for more details</span>
                                    </Link>
                                </div>
                            </CardContent>
                        </Card>
