...
export default function IntroSection() {
    return (
        <section
            id="intro"
            className="bg-gradient-to-r from-cyan-50 to-white py-16 px-4"
        >
            <div className="container mx-auto px-6 md:px-10 flex flex-col-reverse md:flex-row items-center gap-10">           
                {/* Left Content */}
                <div className="md:w-1/2 text-center md:text-left">
                    <h1 className="text-2xl font-bold leading-tight text-gray-900 mb-6">
                    ...
                    <Link href="#about">
                        <Button className="bg-cyan-600 hover:bg-cyan-700 text-white px-6 py-2 text-sm md:text-base">
                            Get Started
                        </Button>
                    </Link>
                </div>
