        ...
        <div className="grid md:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          >
            <div className="relative overflow-hidden glass-card rounded-3xl p-5 md:p-7 max-w-xl transition-all duration-300 hover:shadow-[0_24px_50px_-30px_rgba(8,145,178,0.55)]">
              ...
              <motion.div
                aria-hidden
                className="absolute top-0 left-0 h-full w-1/2 bg-[#17518f] dark:bg-[#302104] border-r border-amber-300/20 dark:border-amber-700/30"
                initial={{ x: 0 }}
                whileInView={{ x: "-110%" }}
                viewport={{ once: true }}
              ...
              <motion.div
                aria-hidden
                className="absolute top-0 right-0 h-full w-1/2 bg-[#17518f] dark:bg-[#302104] border-l border-amber-300/20 dark:border-amber-700/30"
                initial={{ x: 0 }}
                whileInView={{ x: "110%" }}
                viewport={{ once: true }}
                transition={{ duration: 2.2, delay: 1.4, ease: [0.22, 1, 0.36, 1] }}
