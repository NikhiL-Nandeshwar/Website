...
export default function AboutSection() {
    return (
        <section id="about" className="py-10 px-5 bg-white dark:bg-gray-700">
            <div className="container mx-auto px-8">
                <div className="flex flex-col md:flex-row gap-10 items-start">
                    ...
                    <div className="md:w-1/2 p-3">
                        <h2 className="text-3xl font-bold mb-4 dark:text-gray-400">About Us</h2>
                        ...
                        <p className="text-gray-600 mb-4 dark:text-cyan-600">
                            At <span className="font-semibold text-cyan-600 dark:text-gray-400">Demo Company</span>, we’re on a mission to simplify digital transformation for schools, educational institutes and businesses. Our team blends innovation, functionality, and user-first thinking to deliver results that matter.
                        </p>
                        <p className="text-gray-600 mb-4 dark:text-cyan-600">
                        ...
                        <p className="text-gray-600 mb-6 dark:text-cyan-600">
                        ...
                        <ul className="space-y-3 font-medium text-gray-700 dark:text-cyan-600">
                            {[
