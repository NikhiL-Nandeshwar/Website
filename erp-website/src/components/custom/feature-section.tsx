...
import { ShieldCheck, Zap, Layers3, LayoutGrid } from "lucide-react"
...
const features = [
  ...
  {
    title: "Modern Websites that Reflect Your Identity",
    desc: "We design fast, responsive, and SEO-friendly sites that build credibility and attract leads/interactions.",
    icon: LayoutGrid,
  },
  {
...
export default function FeaturesSection() {
  return (
    <section
      id="features"
      className="py-24 bg-gradient-to-b from-white via-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"
    >
